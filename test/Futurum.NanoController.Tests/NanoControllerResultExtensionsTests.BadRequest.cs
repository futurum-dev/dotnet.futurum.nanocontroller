...
public class NanoControllerResultExtensionsBadRequestTests
{
    ...
    public class Sync
    {
        public class NonGeneric
        {
            ...
            public void Failure()
            {
                ...
                var actionResult = result.ToBadRequest(new TestNanoController());
    ...
    public class Async
    {
        public class NonGeneric
        {
            ...
            public async Task Failure()
            {
                ...
                var actionResult = await result.ToBadRequestAsync(new TestNanoController());
